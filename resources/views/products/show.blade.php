...
@section('content')
    ...
    <div class="mb-3">
        ...
        <input type="number" min="0" max="1000" value="{{ $product->qty }}" name="qty" readonly
            id="qtyText" class="form-control" placeholder="Enter Qty">
    </div>
    <div class="mb-3">
        <label for="priceText" class="form-label">Price</label>
        <input type="number" min="0" max="1000" step="0.01" value="{{ $product->price }}" readonly
            name="price" id="priceText" class="form-control" placeholder="Enter Price">
    </div>
    <div class="mb-3">
